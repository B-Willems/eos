...
proc create_root_design { parentCell } {
  ...
  set_property -dict [ list \
   ...
   CONFIG.CLKOUT1_JITTER {173.188} \
   CONFIG.CLKOUT1_PHASE_ERROR {109.791} \
   CONFIG.CLKOUT1_REQUESTED_OUT_FREQ {50.000} \
   CONFIG.CLKOUT2_JITTER {156.423} \
   CONFIG.CLKOUT2_PHASE_ERROR {112.219} \
  ...
  connect_bd_net -net WS2812_0_d_out [get_bd_ports dout_0] [get_bd_pins WS2812_0/d_out]
  connect_bd_net -net clk_wiz_0_clk_out1 [get_bd_pins WS2812_0/clk] [get_bd_pins clk_wiz_0/clk_out1]
