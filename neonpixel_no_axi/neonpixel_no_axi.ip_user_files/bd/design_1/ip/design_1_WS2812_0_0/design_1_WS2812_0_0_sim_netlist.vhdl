...
-- Date        : Thu Oct 28 18:14:00 2021
-- Host        : bram-ubuntu running 64-bit Ubuntu 20.04.3 LTS
-- Command     : write_vhdl -force -mode funcsim
--               /home/bram/eos/neonpixel_no_axi/neonpixel_no_axi.gen/sources_1/bd/design_1/ip/design_1_WS2812_0_0/design_1_WS2812_0_0_sim_netlist.vhdl
...
architecture STRUCTURE of design_1_WS2812_0_0_WS2812 is
  ...
  signal \delay_high_cntr[4]_i_3_n_0\ : STD_LOGIC;
  signal \delay_high_cntr[4]_i_4_n_0\ : STD_LOGIC;
  signal \delay_high_cntr[4]_i_5_n_0\ : STD_LOGIC;
  signal \delay_high_cntr[5]_i_1_n_0\ : STD_LOGIC;
  signal \delay_high_cntr[6]_i_1_n_0\ : STD_LOGIC;
  signal \delay_high_cntr[7]_i_1_n_0\ : STD_LOGIC;
  signal \delay_high_cntr[8]_i_1_n_0\ : STD_LOGIC;
  ...
  signal \delay_high_cntr[8]_i_6_n_0\ : STD_LOGIC;
  signal \delay_high_cntr[9]_i_1_n_0\ : STD_LOGIC;
  signal \delay_high_cntr[9]_i_2_n_0\ : STD_LOGIC;
  signal \delay_high_cntr[9]_i_3_n_0\ : STD_LOGIC;
  signal \delay_high_cntr[9]_i_5_n_0\ : STD_LOGIC;
  signal \delay_high_cntr[9]_i_6_n_0\ : STD_LOGIC;
  signal \delay_high_cntr[9]_i_7_n_0\ : STD_LOGIC;
  signal \delay_high_cntr[9]_i_8_n_0\ : STD_LOGIC;
  signal \delay_high_cntr[9]_i_9_n_0\ : STD_LOGIC;
  ...
  signal \delay_high_cntr_reg[4]_i_1_n_0\ : STD_LOGIC;
  signal \delay_high_cntr_reg[4]_i_1_n_1\ : STD_LOGIC;
  signal \delay_high_cntr_reg[4]_i_1_n_2\ : STD_LOGIC;
  signal \delay_high_cntr_reg[4]_i_1_n_3\ : STD_LOGIC;
  signal \delay_high_cntr_reg[8]_i_2_n_0\ : STD_LOGIC;
  signal \delay_high_cntr_reg[8]_i_2_n_1\ : STD_LOGIC;
  signal \delay_high_cntr_reg[8]_i_2_n_2\ : STD_LOGIC;
  signal \delay_high_cntr_reg[8]_i_2_n_3\ : STD_LOGIC;
  signal \delay_high_cntr_reg[9]_i_4_n_1\ : STD_LOGIC;
  signal \delay_high_cntr_reg[9]_i_4_n_2\ : STD_LOGIC;
  signal \delay_high_cntr_reg[9]_i_4_n_3\ : STD_LOGIC;
  signal \delay_high_cntr_reg[9]_i_4_n_4\ : STD_LOGIC;
  signal \delay_high_cntr_reg[9]_i_4_n_5\ : STD_LOGIC;
  signal \delay_high_cntr_reg[9]_i_4_n_6\ : STD_LOGIC;
  ...
  signal \delay_low_cntr[1]_i_2_n_0\ : STD_LOGIC;
  ...
  signal \delay_low_cntr_reg[1]_i_1_n_0\ : STD_LOGIC;
  signal \delay_low_cntr_reg[1]_i_1_n_1\ : STD_LOGIC;
  signal \delay_low_cntr_reg[1]_i_1_n_2\ : STD_LOGIC;
  signal \delay_low_cntr_reg[1]_i_1_n_3\ : STD_LOGIC;
  ...
  signal \NLW_delay_high_cntr_reg[9]_i_4_CO_UNCONNECTED\ : STD_LOGIC_VECTOR ( 3 to 3 );
  signal \NLW_delay_high_cntr_reg[9]_i_4_O_UNCONNECTED\ : STD_LOGIC_VECTOR ( 0 to 0 );
  ...
  attribute ADDER_THRESHOLD of \delay_high_cntr_reg[4]_i_1\ : label is 35;
  attribute ADDER_THRESHOLD of \delay_high_cntr_reg[8]_i_2\ : label is 35;
  ...
  attribute SOFT_HLUTNM of \delay_low_cntr[7]_i_1\ : label is "soft_lutpair0";
  attribute SOFT_HLUTNM of \delay_low_cntr[9]_i_1\ : label is "soft_lutpair1";
  ...
  attribute ADDER_THRESHOLD of \delay_low_cntr_reg[1]_i_1\ : label is 35;
...
\delay_high_cntr[1]_i_1\: unisim.vcomponents.LUT5
    generic map(
      ...
      I1 => \state_reg_n_0_[1]\,
      I2 => \delay_high_cntr[9]_i_5_n_0\,
      I3 => \delay_high_cntr_reg[9]_i_4_n_4\,
      I4 => \delay_high_cntr[9]_i_3_n_0\,
...
\delay_high_cntr[4]_i_2\: unisim.vcomponents.LUT1
    generic map(
      INIT => X"1"
    )
        port map (
...
\delay_high_cntr[4]_i_3\: unisim.vcomponents.LUT1
    generic map(
      INIT => X"1"
    )
        port map (
...
\delay_high_cntr[4]_i_4\: unisim.vcomponents.LUT1
    generic map(
      INIT => X"1"
    )
        port map (
...
\delay_high_cntr[4]_i_5\: unisim.vcomponents.LUT1
    generic map(
      INIT => X"1"
    )
        port map (
...
\delay_high_cntr[5]_i_1\: unisim.vcomponents.LUT5
    generic map(
      ...
      I1 => \state_reg_n_0_[1]\,
      I2 => \delay_high_cntr[9]_i_3_n_0\,
      I3 => \delay_high_cntr_reg[9]_i_4_n_4\,
      I4 => \delay_high_cntr[9]_i_5_n_0\,
      O => \delay_high_cntr[5]_i_1_n_0\
    );
\delay_high_cntr[6]_i_1\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"888BBB8B"
    )
        port map (
      I0 => delay_high_cntr0(6),
      I1 => \state_reg_n_0_[1]\,
      I2 => \delay_high_cntr[9]_i_5_n_0\,
      I3 => \delay_high_cntr_reg[9]_i_4_n_4\,
      I4 => \delay_high_cntr[9]_i_3_n_0\,
      O => \delay_high_cntr[6]_i_1_n_0\
    );
\delay_high_cntr[7]_i_1\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"B8BBB888"
    )
        port map (
      I0 => delay_high_cntr0(7),
      I1 => \state_reg_n_0_[1]\,
      I2 => \delay_high_cntr[9]_i_3_n_0\,
      I3 => \delay_high_cntr_reg[9]_i_4_n_4\,
      I4 => \delay_high_cntr[9]_i_5_n_0\,
      O => \delay_high_cntr[7]_i_1_n_0\
    );
\delay_high_cntr[8]_i_1\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"888BBB8B"
    )
        port map (
      I0 => delay_high_cntr0(8),
      I1 => \state_reg_n_0_[1]\,
      I2 => \delay_high_cntr[9]_i_5_n_0\,
      I3 => \delay_high_cntr_reg[9]_i_4_n_4\,
      I4 => \delay_high_cntr[9]_i_3_n_0\,
      O => \delay_high_cntr[8]_i_1_n_0\
    );
...
\delay_high_cntr[8]_i_6\: unisim.vcomponents.LUT1
    generic map(
      INIT => X"1"
    )
        port map (
      I0 => delay_high_cntr(5),
      O => \delay_high_cntr[8]_i_6_n_0\
    );
\delay_high_cntr[9]_i_1\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"3808"
    )
        port map (
      ...
      O => \delay_high_cntr[9]_i_1_n_0\
    );
\delay_high_cntr[9]_i_2\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"B8BBB888"
    )
        port map (
      I0 => delay_high_cntr0(9),
      I1 => \state_reg_n_0_[1]\,
      I2 => \delay_high_cntr[9]_i_3_n_0\,
      I3 => \delay_high_cntr_reg[9]_i_4_n_4\,
      I4 => \delay_high_cntr[9]_i_5_n_0\,
      O => \delay_high_cntr[9]_i_2_n_0\
    );
\delay_high_cntr[9]_i_3\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"B8"
    )
        port map (
      I0 => GRB(5),
      I1 => \delay_high_cntr_reg[9]_i_4_n_6\,
      I2 => GRB(4),
      O => \delay_high_cntr[9]_i_3_n_0\
    );
\delay_high_cntr[9]_i_5\: unisim.vcomponents.LUT6
    generic map(
      ...
      I0 => GRB(3),
      I1 => GRB(2),
      I2 => \delay_high_cntr_reg[9]_i_4_n_5\,
      I3 => GRB(1),
      I4 => \delay_high_cntr_reg[9]_i_4_n_6\,
      I5 => GRB(0),
      O => \delay_high_cntr[9]_i_5_n_0\
    );
\delay_high_cntr[9]_i_6\: unisim.vcomponents.LUT1
    generic map(
      INIT => X"1"
    )
        port map (
      I0 => bit_cntr_reg(4),
      O => \delay_high_cntr[9]_i_6_n_0\
    );
\delay_high_cntr[9]_i_7\: unisim.vcomponents.LUT1
    generic map(
      INIT => X"1"
    )
        port map (
      I0 => bit_cntr_reg(3),
      O => \delay_high_cntr[9]_i_7_n_0\
    );
\delay_high_cntr[9]_i_8\: unisim.vcomponents.LUT1
    generic map(
      INIT => X"1"
    )
        port map (
      I0 => bit_cntr_reg(2),
      O => \delay_high_cntr[9]_i_8_n_0\
    );
\delay_high_cntr[9]_i_9\: unisim.vcomponents.LUT1
    generic map(
      INIT => X"1"
    )
        port map (
      I0 => bit_cntr_reg(1),
      O => \delay_high_cntr[9]_i_9_n_0\
    );
...
\delay_high_cntr_reg[12]_i_1\: unisim.vcomponents.CARRY4
     port map (
      CI => \delay_high_cntr_reg[8]_i_2_n_0\,
...
\delay_high_cntr_reg[4]\: unisim.vcomponents.FDSE
    generic map(
      INIT => '0'
    )
        port map (
      C => clk,
      CE => \delay_high_cntr[9]_i_1_n_0\,
      D => delay_high_cntr0(4),
      Q => delay_high_cntr(4),
      S => \delay_high_cntr[31]_i_1_n_0\
    );
\delay_high_cntr_reg[4]_i_1\: unisim.vcomponents.CARRY4
     port map (
      CI => '0',
      CO(3) => \delay_high_cntr_reg[4]_i_1_n_0\,
      CO(2) => \delay_high_cntr_reg[4]_i_1_n_1\,
      CO(1) => \delay_high_cntr_reg[4]_i_1_n_2\,
      CO(0) => \delay_high_cntr_reg[4]_i_1_n_3\,
      CYINIT => delay_high_cntr(0),
      DI(3 downto 0) => delay_high_cntr(4 downto 1),
      O(3 downto 0) => delay_high_cntr0(4 downto 1),
      S(3) => \delay_high_cntr[4]_i_2_n_0\,
      S(2) => \delay_high_cntr[4]_i_3_n_0\,
      S(1) => \delay_high_cntr[4]_i_4_n_0\,
      S(0) => \delay_high_cntr[4]_i_5_n_0\
    );
...
\delay_high_cntr_reg[8]\: unisim.vcomponents.FDRE
    generic map(
      ...
      C => clk,
      CE => \delay_high_cntr[9]_i_1_n_0\,
      D => \delay_high_cntr[8]_i_1_n_0\,
      Q => delay_high_cntr(8),
      R => '0'
    );
\delay_high_cntr_reg[8]_i_2\: unisim.vcomponents.CARRY4
     port map (
      CI => \delay_high_cntr_reg[4]_i_1_n_0\,
      CO(3) => \delay_high_cntr_reg[8]_i_2_n_0\,
      CO(2) => \delay_high_cntr_reg[8]_i_2_n_1\,
      CO(1) => \delay_high_cntr_reg[8]_i_2_n_2\,
      CO(0) => \delay_high_cntr_reg[8]_i_2_n_3\,
      CYINIT => '0',
      DI(3 downto 0) => delay_high_cntr(8 downto 5),
      O(3 downto 0) => delay_high_cntr0(8 downto 5),
      S(3) => \delay_high_cntr[8]_i_3_n_0\,
      S(2) => \delay_high_cntr[8]_i_4_n_0\,
      S(1) => \delay_high_cntr[8]_i_5_n_0\,
      S(0) => \delay_high_cntr[8]_i_6_n_0\
    );
\delay_high_cntr_reg[9]\: unisim.vcomponents.FDRE
    generic map(
      ...
      C => clk,
      CE => \delay_high_cntr[9]_i_1_n_0\,
      D => \delay_high_cntr[9]_i_2_n_0\,
      Q => delay_high_cntr(9),
      R => '0'
    );
\delay_high_cntr_reg[9]_i_4\: unisim.vcomponents.CARRY4
     port map (
      CI => '0',
      CO(3) => \NLW_delay_high_cntr_reg[9]_i_4_CO_UNCONNECTED\(3),
      CO(2) => \delay_high_cntr_reg[9]_i_4_n_1\,
      CO(1) => \delay_high_cntr_reg[9]_i_4_n_2\,
      CO(0) => \delay_high_cntr_reg[9]_i_4_n_3\,
      CYINIT => bit_cntr_reg(0),
      DI(3) => '0',
      DI(2 downto 0) => bit_cntr_reg(3 downto 1),
      O(3) => \delay_high_cntr_reg[9]_i_4_n_4\,
      O(2) => \delay_high_cntr_reg[9]_i_4_n_5\,
      O(1) => \delay_high_cntr_reg[9]_i_4_n_6\,
      O(0) => \NLW_delay_high_cntr_reg[9]_i_4_O_UNCONNECTED\(0),
      S(3) => \delay_high_cntr[9]_i_6_n_0\,
      S(2) => \delay_high_cntr[9]_i_7_n_0\,
      S(1) => \delay_high_cntr[9]_i_8_n_0\,
      S(0) => \delay_high_cntr[9]_i_9_n_0\
    );
...
\delay_low_cntr[1]_i_2\: unisim.vcomponents.LUT1
    generic map(
      INIT => X"1"
    )
        port map (
      I0 => delay_low_cntr(4),
      O => \delay_low_cntr[1]_i_2_n_0\
    );
...
\delay_low_cntr[2]_i_1\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"8B"
    )
        port map (
...
\delay_low_cntr[3]_i_1\: unisim.vcomponents.LUT6
    generic map(
      ...
      I1 => \state_reg_n_0_[1]\,
      I2 => \bit_cntr0_carry__2_n_0\,
      I3 => \delay_high_cntr[9]_i_3_n_0\,
      I4 => \delay_high_cntr_reg[9]_i_4_n_4\,
      I5 => \delay_high_cntr[9]_i_5_n_0\,
...
\delay_low_cntr[6]_i_1\: unisim.vcomponents.LUT6
    generic map(
...
\delay_low_cntr[8]_i_1\: unisim.vcomponents.LUT6
    generic map(
...
\delay_low_cntr_reg[1]_i_1\: unisim.vcomponents.CARRY4
     port map (
      CI => '0',
      CO(3) => \delay_low_cntr_reg[1]_i_1_n_0\,
      CO(2) => \delay_low_cntr_reg[1]_i_1_n_1\,
      CO(1) => \delay_low_cntr_reg[1]_i_1_n_2\,
      CO(0) => \delay_low_cntr_reg[1]_i_1_n_3\,
      CYINIT => delay_low_cntr(0),
      DI(3 downto 0) => delay_low_cntr(4 downto 1),
      O(3 downto 0) => delay_low_cntr0(4 downto 1),
      S(3) => \delay_low_cntr[1]_i_2_n_0\,
      S(2) => \delay_low_cntr[1]_i_3_n_0\,
      S(1) => \delay_low_cntr[1]_i_4_n_0\,
      S(0) => \delay_low_cntr[1]_i_5_n_0\
    );
...
\delay_low_cntr_reg[8]_i_2\: unisim.vcomponents.CARRY4
     port map (
      CI => \delay_low_cntr_reg[1]_i_1_n_0\,
...
entity design_1_WS2812_0_0 is
  ...
  attribute x_core_info of design_1_WS2812_0_0 : entity is "WS2812,Vivado 2021.1";
