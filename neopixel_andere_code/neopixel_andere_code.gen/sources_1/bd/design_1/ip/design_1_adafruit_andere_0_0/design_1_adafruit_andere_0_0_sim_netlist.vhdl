...
--               /home/bram/eos/neopixel_andere_code/neopixel_andere_code.gen/sources_1/bd/design_1/ip/design_1_adafruit_andere_0_0/design_1_adafruit_andere_0_0_sim_netlist.vhdl
...
entity design_1_adafruit_andere_0_0_ws2812b is
  port (
    dout : out STD_LOGIC;
    clk : in STD_LOGIC;
  ...
  attribute ORIG_REF_NAME of design_1_adafruit_andere_0_0_ws2812b : entity is "ws2812b";
end design_1_adafruit_andere_0_0_ws2812b;

architecture STRUCTURE of design_1_adafruit_andere_0_0_ws2812b is
  signal bit_count : STD_LOGIC;
  signal bit_count0 : STD_LOGIC_VECTOR ( 6 downto 0 );
  signal \bit_count[1]_i_1_n_0\ : STD_LOGIC;
  signal \bit_count[4]_i_1_n_0\ : STD_LOGIC;
  signal bit_count_reg : STD_LOGIC_VECTOR ( 6 downto 0 );
  signal byte_bit : STD_LOGIC_VECTOR ( 2 downto 0 );
  signal \byte_bit[2]_i_10_n_0\ : STD_LOGIC;
  signal \byte_bit[2]_i_2_n_0\ : STD_LOGIC;
  signal \byte_bit[2]_i_4_n_0\ : STD_LOGIC;
  signal \byte_bit[2]_i_5_n_0\ : STD_LOGIC;
  signal \byte_bit[2]_i_6_n_0\ : STD_LOGIC;
  signal \byte_bit[2]_i_7_n_0\ : STD_LOGIC;
  signal \byte_bit[2]_i_8_n_0\ : STD_LOGIC;
  signal \byte_bit[2]_i_9_n_0\ : STD_LOGIC;
  ...
  signal \rom_addr0_inferred__0/i__carry__0_n_2\ : STD_LOGIC;
  signal \rom_addr0_inferred__0/i__carry__0_n_3\ : STD_LOGIC;
  signal \rom_addr0_inferred__0/i__carry__0_n_5\ : STD_LOGIC;
  signal \rom_addr0_inferred__0/i__carry__0_n_6\ : STD_LOGIC;
  signal \rom_addr0_inferred__0/i__carry__0_n_7\ : STD_LOGIC;
  signal \rom_addr0_inferred__0/i__carry_n_0\ : STD_LOGIC;
  signal \rom_addr0_inferred__0/i__carry_n_1\ : STD_LOGIC;
  signal \rom_addr0_inferred__0/i__carry_n_2\ : STD_LOGIC;
  signal \rom_addr0_inferred__0/i__carry_n_3\ : STD_LOGIC;
  signal \rom_addr0_inferred__0/i__carry_n_4\ : STD_LOGIC;
  signal \rom_addr0_inferred__0/i__carry_n_5\ : STD_LOGIC;
  signal \rom_addr0_inferred__0/i__carry_n_6\ : STD_LOGIC;
  signal \rom_addr0_inferred__0/i__carry_n_7\ : STD_LOGIC;
  ...
  signal \NLW_rom_addr0_inferred__0/i__carry__0_CO_UNCONNECTED\ : STD_LOGIC_VECTOR ( 3 downto 2 );
  signal \NLW_rom_addr0_inferred__0/i__carry__0_O_UNCONNECTED\ : STD_LOGIC_VECTOR ( 3 to 3 );
  ...
  attribute SOFT_HLUTNM of \byte_bit[1]_i_1\ : label is "soft_lutpair11";
  attribute SOFT_HLUTNM of \byte_bit[2]_i_10\ : label is "soft_lutpair6";
  attribute SOFT_HLUTNM of \byte_bit[2]_i_3\ : label is "soft_lutpair11";
  attribute SOFT_HLUTNM of \byte_bit[2]_i_4\ : label is "soft_lutpair13";
  attribute SOFT_HLUTNM of \byte_bit[2]_i_5\ : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of \byte_bit[2]_i_6\ : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of \byte_bit[2]_i_9\ : label is "soft_lutpair7";
  ...
  attribute SOFT_HLUTNM of \count[7]_i_2\ : label is "soft_lutpair10";
  attribute SOFT_HLUTNM of \count[8]_i_1\ : label is "soft_lutpair9";
  attribute SOFT_HLUTNM of \count[9]_i_1\ : label is "soft_lutpair9";
  attribute SOFT_HLUTNM of dout_INST_0 : label is "soft_lutpair5";
  attribute SOFT_HLUTNM of \rom_addr[0]_i_1\ : label is "soft_lutpair8";
  attribute SOFT_HLUTNM of \rom_addr[1]_i_1\ : label is "soft_lutpair8";
...
\byte_bit[2]_i_10\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"FE"
    )
        port map (
...
\byte_bit[2]_i_2\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"44400000"
    )
        port map (
...
\byte_bit[2]_i_5\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"7"
    )
        port map (
...
\byte_bit[2]_i_6\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FFEF"
    )
        port map (
...
\byte_bit[2]_i_7\: unisim.vcomponents.LUT6
    generic map(
...
\byte_bit[2]_i_8\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"0001"
    )
        port map (
...
\byte_bit[2]_i_9\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FFFE"
    )
        port map (
...
\rom_addr0_inferred__0/i__carry\: unisim.vcomponents.CARRY4
     port map (
      CI => '0',
      CO(3) => \rom_addr0_inferred__0/i__carry_n_0\,
      CO(2) => \rom_addr0_inferred__0/i__carry_n_1\,
      CO(1) => \rom_addr0_inferred__0/i__carry_n_2\,
      CO(0) => \rom_addr0_inferred__0/i__carry_n_3\,
      CYINIT => '0',
      DI(3) => \i__carry_i_1_n_0\,
      DI(2) => ctrl(0),
      DI(1 downto 0) => B"01",
      O(3) => \rom_addr0_inferred__0/i__carry_n_4\,
      O(2) => \rom_addr0_inferred__0/i__carry_n_5\,
      O(1) => \rom_addr0_inferred__0/i__carry_n_6\,
      O(0) => \rom_addr0_inferred__0/i__carry_n_7\,
      S(3) => \i__carry_i_2_n_0\,
      S(2) => \i__carry_i_3_n_0\,
      S(1) => \i__carry_i_4_n_0\,
      S(0) => ctrl(0)
    );
\rom_addr0_inferred__0/i__carry__0\: unisim.vcomponents.CARRY4
     port map (
      CI => \rom_addr0_inferred__0/i__carry_n_0\,
      CO(3 downto 2) => \NLW_rom_addr0_inferred__0/i__carry__0_CO_UNCONNECTED\(3 downto 2),
      CO(1) => \rom_addr0_inferred__0/i__carry__0_n_2\,
      CO(0) => \rom_addr0_inferred__0/i__carry__0_n_3\,
      CYINIT => '0',
      DI(3 downto 2) => B"00",
      DI(1) => \i__carry__0_i_1_n_0\,
      DI(0) => \i__carry__0_i_2_n_0\,
      O(3) => \NLW_rom_addr0_inferred__0/i__carry__0_O_UNCONNECTED\(3),
      O(2) => \rom_addr0_inferred__0/i__carry__0_n_5\,
      O(1) => \rom_addr0_inferred__0/i__carry__0_n_6\,
      O(0) => \rom_addr0_inferred__0/i__carry__0_n_7\,
      S(3) => '0',
...
\rom_addr[6]_i_3\: unisim.vcomponents.LUT6
    generic map(
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity design_1_adafruit_andere_0_0_adafruit_andere_v1_0_S00_AXI is
  port (
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of design_1_adafruit_andere_0_0_adafruit_andere_v1_0_S00_AXI : entity is "adafruit_andere_v1_0_S00_AXI";
end design_1_adafruit_andere_0_0_adafruit_andere_v1_0_S00_AXI;

architecture STRUCTURE of design_1_adafruit_andere_0_0_adafruit_andere_v1_0_S00_AXI is
...
U1: entity work.design_1_adafruit_andere_0_0_ws2812b
     port map (
      clk => clk,
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity design_1_adafruit_andere_0_0_adafruit_andere_v1_0 is
  port (
    S_AXI_WREADY : out STD_LOGIC;
    S_AXI_AWREADY : out STD_LOGIC;
    S_AXI_ARREADY : out STD_LOGIC;
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of design_1_adafruit_andere_0_0_adafruit_andere_v1_0 : entity is "adafruit_andere_v1_0";
end design_1_adafruit_andere_0_0_adafruit_andere_v1_0;

architecture STRUCTURE of design_1_adafruit_andere_0_0_adafruit_andere_v1_0 is
begin
adafruit_andere_v1_0_S00_AXI_inst: entity work.design_1_adafruit_andere_0_0_adafruit_andere_v1_0_S00_AXI
     port map (
      S_AXI_ARREADY => S_AXI_ARREADY,
      S_AXI_AWREADY => S_AXI_AWREADY,
      S_AXI_WREADY => S_AXI_WREADY,
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity design_1_adafruit_andere_0_0 is
  port (
    clk : in STD_LOGIC;
    dout : out STD_LOGIC;
    ctrl : in STD_LOGIC_VECTOR ( 2 downto 0 );
  ...
  attribute NotValidForBitStream of design_1_adafruit_andere_0_0 : entity is true;
  attribute CHECK_LICENSE_TYPE : string;
  attribute CHECK_LICENSE_TYPE of design_1_adafruit_andere_0_0 : entity is "design_1_adafruit_andere_0_0,adafruit_andere_v1_0,{}";
  attribute downgradeipidentifiedwarnings : string;
  attribute downgradeipidentifiedwarnings of design_1_adafruit_andere_0_0 : entity is "yes";
  attribute x_core_info : string;
  attribute x_core_info of design_1_adafruit_andere_0_0 : entity is "adafruit_andere_v1_0,Vivado 2021.1";
end design_1_adafruit_andere_0_0;

architecture STRUCTURE of design_1_adafruit_andere_0_0 is
  signal \<const0>\ : STD_LOGIC;
  attribute x_interface_info : string;
  attribute x_interface_info of clk : signal is "xilinx.com:signal:clock:1.0 clk CLK";
  attribute x_interface_parameter : string;
  attribute x_interface_parameter of clk : signal is "XIL_INTERFACENAME clk, FREQ_HZ 25000000, FREQ_TOLERANCE_HZ 0, PHASE 0.0, CLK_DOMAIN design_1_processing_system7_0_0_FCLK_CLK1, INSERT_VIP 0";
...
U0: entity work.design_1_adafruit_andere_0_0_adafruit_andere_v1_0
     port map (
