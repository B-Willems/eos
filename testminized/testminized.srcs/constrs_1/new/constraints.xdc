...
set_property PACKAGE_PIN L15 [get_ports {LED_out_0[6]}]
set_property PACKAGE_PIN M14 [get_ports {LED_out_0[5]}]
set_property PACKAGE_PIN L14 [get_ports {LED_out_0[4]}]
set_property PACKAGE_PIN L13 [get_ports {LED_out_0[3]}]
set_property PACKAGE_PIN K13 [get_ports {LED_out_0[2]}]
set_property PACKAGE_PIN N14 [get_ports {LED_out_0[1]}]
set_property PACKAGE_PIN N13 [get_ports {LED_out_0[0]}]
