...
execute()
{
  xrun $xrun_opts \
       ...
       -f run.f \
       -top glbl \
       +incdir+"../../../../zevensegment_customIP.gen/sources_1/bd/design_1/ipshared/ec67/hdl" \
       +incdir+"../../../../zevensegment_customIP.gen/sources_1/bd/design_1/ipshared/f42d/hdl" \
       +incdir+"/tools/Xilinx/Vivado/2021.1/data/xilinx_vip/include"
}
